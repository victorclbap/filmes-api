...
namespace FilmesApi.Data
{
    public class FilmeContext : DbContext
    {
        ...
        {
            // constrói relacionamento muitos para muitos
            builder.Entity<Sessao>().HasKey(sessao => new { sessao.FilmeId, sessao.CinemaId }); // sessão tem como chave filmeid e cinemaid
